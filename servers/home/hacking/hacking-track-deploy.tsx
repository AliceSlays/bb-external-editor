...
export class PlanTracker {
  ...
  constructor(plan_start: number, plan_end: number, pattern: HackActionType[] = [HackActionType['W'], HackActionType['G'], HackActionType['W'], HackActionType['H']]) {
  ...
  can_deploy(actionType: HackActionType, duration: number, pos:number): boolean {
    ...
    if(HackActionType['W']==actionType && pos_in_plan == 0 ){
      return true;
    }
    if(!this.is_active()){
      return false
